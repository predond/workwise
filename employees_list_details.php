...
<body class="zoom content">
  ...
  <main id="employeeDetails">
    <div class="return" data-location="employees_list.php"></div>
    <div>
      <img src="assets/employee_1.png" alt="osoba">
    </div>
    <div>
      <h2>Imię i nazwisko</h2>
      <p class="hr"></p>
      <p>Telefon: 000 000 000</p>
      <p>Email: osoba@workwise.pl</p>
      <p>Adres: Pracowita 53, 53-535 Przepiórków</p>
      <p>Zarobki: 2 400zł</p>
    </div>
  </main>
  <footer>
