...
function CalendarPicker(element, options) {
    ...
    this.previousMonthArrowDisabled = document.createElement('p');
    this.nextMonthArrowDisabled = document.createElement('p');
    ...
    this.previousMonthArrowDisabled.id = 'previous-month-disabled';
    this.nextMonthArrowDisabled.id = 'next-month-disabled';
...
CalendarPicker.prototype._insertNavigationButtons = function () {
    ...
    var arrowSvg = '<svg enable-background="new 0 0 386.257 386.257" viewBox="0 0 386.257 386.257" xmlns="http://www.w3.org/2000/svg"><path d="m0 96.879 193.129 192.5 193.128-192.5z" style="fill: #0F3A5E;"/></svg>';

    this.previousMonthArrow.innerHTML = arrowSvg;
    this.nextMonthArrow.innerHTML = arrowSvg;
    this.previousMonthArrowDisabled.innerHTML = arrowSvg;
    this.nextMonthArrowDisabled.innerHTML = arrowSvg;
    ...
    this.navigationWrapper.appendChild(this.previousMonthArrowDisabled);
    this.navigationWrapper.appendChild(this.nextMonthArrowDisabled);
...
CalendarPicker.prototype._toggleNavigationButtons = function() {
    var previousMonthExceeded = !!this.min && this._beginningOfMonth(this.date) <= this.min;
    var nextMonthExceeded = !!this.max && this._endOfMonth(this.date) >= new Date(this.max.getFullYear(), this.max.getMonth() + 1);
    ...
    this.previousMonthArrow.style.display = previousMonthExceeded ? 'none' : 'initial';
    this.previousMonthArrowDisabled.style.display = !previousMonthExceeded ? 'none' : 'initial';
    this.nextMonthArrow.style.display = nextMonthExceeded ? 'none' : 'initial';
    this.nextMonthArrowDisabled.style.display = !nextMonthExceeded ? 'none' : 'initial';
}
...
CalendarPicker.prototype._updateCalendar = function () {
    ...
    this.dateNextMonth = new Date(this.year, this.month + 1)
